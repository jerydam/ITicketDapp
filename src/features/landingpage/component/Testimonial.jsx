...
function Testimonials() {
  return (
    <div className="container mx-auto px-4 py-12 lg:px-8 text-[#0c0202] font-boldrounded">
        <div id="test" style={{transition:"1s ease-in-out",paddingLeft:"3%", paddingRight:"3%", border:"bold"}}>
      <h4 className="text-4xl text-center mb-8">How Our Users Feel</h4>
      <div className="flex flex-wrap justify-center -mx-4 lg:-mx-8">
        <div className="rounded-lg border hover:border-[#9CA3AF] p-1  w-full lg:w-1/3 px-4 lg:px-8 mb-8 lg:mb-0 ">
